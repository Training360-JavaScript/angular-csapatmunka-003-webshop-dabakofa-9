...
export class ProductService {
  ...
  list: Product[] = [
    ...
    },
    {
      ...
      description:
        'A Varázsló a sufnimban folytatása! Vanheldon, a vandálok királya nem lát a pipától, amióta Merdyn kővé változtatta a seregét. Bosszúvágyában ördögi tervet eszel ki: elrabolja Rose-t, visszaviszi a középkorba, és csaliként használja a varázslónak állított csapdában. De a lánya, akit a jövőbe küld, véletlenül Rose bátyját, Krist dugja a zsákjába. Uppsz!',
    ...
    },
    {
      ...
      description:
        'Goni egy totál rossz ördögkölyök, aki képtelen leszokni a jóságról. Rémálom tud lenni az élete, mert folyton elbukik a gonoszságban. Vajon lesz belőle vérbeli pokolfajzat?',
    ...
    },
    {
      ...
      description:
        'Enola Holmesnak egymagában kell boldogulnia a világ legnagyobb, legmocs-kosabb és legveszélyesebb városában, miközben a világ leghíresebb nyomozója - történetesen a bátyja -, Sherlock Holmes vadászik rá. Szabadsága érdekében menekülnie kell a családja elől, de hol találhat társakra?',
    ...
    },
    {
      ...
      description:
        'Igazi irodalmi felfedezés ez a magyarul eddig még soha meg nem jelent Habe-regény. A nagyívű kortörténeti művet a méltán népszerű szerző a lerombolt Németországban, az 1945-47 között átélt események hatása alatt írta. A középpontban két megszálló tiszt élményei állnak; emberiességük és közös meggyőződésük barátokká teszi őket. Mindketten házasok, de hosszú időre Európába vezette őket a háború. Mindkét férfinek drámai szerelmeket hoz személyes sorsa, miközben kemény hadászati és politikai történetek részeseivé válnak. A létfontosságú és izgalmas események révén a barátok felismerhetik, hová tartoznak: oda, ahol a legtöbbet tehetik.',
    ...
    },
    {
      ...
      author: 'Pintér Tamás',
      title:
        'Vadnyugat - Észak-Amerika legszebb nemzeti parkjai - A Grand Circle',
      description:
        'A sorozat első kötetében a szerző a geológiai csodáiról híres dél-nyugat nemzeti parkjaiban(Grand Canyon, Zion, Bryce Canyon, Arches) tett utazásainak élményét osztja meg az olvasóval. A túraútvonalak leírása mellé adott információk egyaránt segítik azt, aki utazni vágyik, és ablakot nyit egy különleges világra azoknak, akik még csak barátkoznak ennek gondolatával.',
    ...
    },
    {
      ...
      description:
        'A kötet a szerző több mint 2000 csodás fotója segítségével kalauzolja végig az olvasót Felvidék ismert és kevésbé ismert városain, nevezetességein át az egészen elrejtett természeti kincsek, kulturális örökségek felkutatásáig. Így egy kötetben még senki sem mutatta be a Felvidéket a maga teljességében.',
